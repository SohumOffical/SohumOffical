...
import com.totemsoft.screenlookcount.fragment.main.FirstPickupFragment
...
class FirstPickupActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_first_pickup)
    ...
    override fun onStart() {
        ...
        if (!isFragmentInBackStack(C.FRAGMENT_TAG_MAIN)) {
            addFragment(FirstPickupFragment::class.java, C.FRAGMENT_TAG_MAIN, sv_container, false, null)
        }
    }
