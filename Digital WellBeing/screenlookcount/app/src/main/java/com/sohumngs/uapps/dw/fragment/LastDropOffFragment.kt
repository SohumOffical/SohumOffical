...
class LastDropOffFragment : BaseFragment(), MainContract.View{
    ...
    override fun onResume() {
        ...
        context?.let {
            ...
            presenter.setCountersValues(it, nowDateString, "lastdropoff")
    ...
    override fun setCountersView(looks: Int?, type: String?, min: Long, max: Long, arr: LongArray) {
            ...
            if(d2.minutes<10){
                ...
                currentView.min.text =""+d2.hours + ":0" +d2.minutes
