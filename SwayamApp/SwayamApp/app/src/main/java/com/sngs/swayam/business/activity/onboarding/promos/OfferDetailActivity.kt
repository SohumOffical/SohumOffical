...
class OfferDetailActivity : AppCompatActivity()
{
    ...
    private fun api_calling_for_user_promotion_list()
    {
        ...
        ServiceCall.calGetCustomerPromotionDetailList(this, auth_id, auth_token, Links.User_Type)
    ...
    private fun set_data()
    {
        ...
        service_desc_txt.setText("Service Description : "+Links.PromotionList_Result.get(selected_pos).promotionDescription)

        like_txt.setText(""+resources.getString(R.string.likes)+"("+
                Links.PromotionList_Result.get(selected_pos).getmTotalLike()+")")
        dislike_txt.setText(""+resources.getString(R.string.dislikes)+"("+
                Links.PromotionList_Result.get(selected_pos).getmTotalDeslike()+")")
        viwer_count_txt.setText(""+resources.getString(R.string.views)+" "
                +Links.PromotionList_Result.get(selected_pos).getmTotalViewed())
