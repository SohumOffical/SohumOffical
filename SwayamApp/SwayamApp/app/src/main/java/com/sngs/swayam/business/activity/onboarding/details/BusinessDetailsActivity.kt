...
class BusinessDetailsActivity : AppCompatActivity() {
    ...
    private fun set_selected_empl() {
        txt_1_5.setBackgroundResource(R.drawable.contact_shape_deselected)
        txt_1_5.setTextColor(resources.getColor(R.color.black))

        txt_5_10.setBackgroundResource(R.drawable.contact_shape_deselected)
        txt_5_10.setTextColor(resources.getColor(R.color.black))

        txt_10_30.setBackgroundResource(R.drawable.contact_shape_deselected)
        txt_10_30.setTextColor(resources.getColor(R.color.black))

        txt_30_60.setBackgroundResource(R.drawable.contact_shape_deselected)
        txt_30_60.setTextColor(resources.getColor(R.color.black))

        if(employee_click==0){
            txt_1_5.setBackgroundResource(R.drawable.contact_shape)
            txt_1_5.setTextColor(resources.getColor(R.color.white))

            employee_selection = txt_1_5.text.toString()
        }
        else  if(employee_click==1){
            txt_5_10.setBackgroundResource(R.drawable.contact_shape)
            txt_5_10.setTextColor(resources.getColor(R.color.white))

            employee_selection = txt_5_10.text.toString()
        }
        else  if(employee_click==2){
            txt_10_30.setBackgroundResource(R.drawable.contact_shape)
            ...
            txt_30_60.setBackgroundResource(R.drawable.contact_shape)
    ...
    private fun set_selected_week() {
        ...
        if(week_click==0){
            if(sun){
                sun = false
                btnsun.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnsun.setTextColor(resources.getColor(R.color.black))
            }
            else{
                sun = true
                btnsun.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(mon){
                mon = false
                btnmon.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnmon.setTextColor(resources.getColor(R.color.black))
            }
            else{
                mon = true
                btnmon.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(tue){
                tue = false
                btntue.setBackgroundResource(R.drawable.contact_shape_deselected)
                btntue.setTextColor(resources.getColor(R.color.black))
            }
            else{
                tue = true
                btntue.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(wed){
                wed = false
                btnwed.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnwed.setTextColor(resources.getColor(R.color.black))
            }
            else{
                wed = true
                btnwed.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(thu){
                thu = false
                btnthu.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnthu.setTextColor(resources.getColor(R.color.black))
            }
            else{
                thu = true
                btnthu.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(fri){
                fri = false
                btnfri.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnfri.setTextColor(resources.getColor(R.color.black))
            }
            else{
                fri = true
                btnfri.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(sat){
                sat = false
                btnsat.setBackgroundResource(R.drawable.contact_shape_deselected)
                btnsat.setTextColor(resources.getColor(R.color.black))
            }
            else{
                sat = true
                btnsat.setBackgroundResource(R.drawable.contact_shape)
            ...
            if(days_24){
                days_24 = false
                btn_hours.setBackgroundResource(R.drawable.contact_shape_deselected)
                btn_hours.setTextColor(resources.getColor(R.color.black))
            }
            else{
                days_24 = true
                btn_hours.setBackgroundResource(R.drawable.contact_shape)
    ...
    private fun init()
    {
        ...
        val currentHour = cal[Calendar.HOUR]
