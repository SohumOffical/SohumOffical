...
import com.sngs.swayam.business.activity.BusinessDetailsActivity
import com.sngs.swayam.business.activity.HomeActivity
import com.sngs.swayam.business.activity.ProfileDetailActivity
import com.sngs.swayam.business.activity.ServicesProvidersActivity
...
class VerificationActivity : AppCompatActivity() {
    ...
    private fun move_next_page() {
        if(page_type.equals("1")){
            ...
            else if(Step_completed.equals("2")){
