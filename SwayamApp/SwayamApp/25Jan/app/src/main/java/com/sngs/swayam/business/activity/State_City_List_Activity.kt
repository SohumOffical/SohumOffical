...
import com.sngs.swayam.business.adapters.CityListAdapter
import com.sngs.swayam.business.adapters.ServicesListAdapter
import com.sngs.swayam.business.adapters.StateListAdapter
                ...
                override fun onResponse(call: Call<GetStateListBaseResponse>, response: Response<GetStateListBaseResponse>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success_v?.toInt()==1)
                        {
                            ...
                            state_city_rv_list.adapter = StateListAdapter(Links.state_list, this@State_City_List_Activity)
                        }
                        else {
                ...
                override fun onResponse(call: Call<GetCityListBaseResponse>, response: Response<GetCityListBaseResponse>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success_v?.toInt()==1)
                        {
                            ...
                            state_city_rv_list.adapter = CityListAdapter(Links.city_list, this@State_City_List_Activity)
                        }
                        else {
                            Snackbar.make(main_layout, "" + response.body()?.message, Snackbar.LENGTH_LONG).show()
                        }
                ...
                override fun onResponse(call: Call<GetAreaListBaseResponse>, response: Response<GetAreaListBaseResponse>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success_v?.toInt()==1)
                        {
                            ...
                            state_city_rv_list.adapter = ServicesListAdapter(Links.area_list, this@State_City_List_Activity)
                        }
                        else {
                            Snackbar.make(main_layout, "" + response.body()?.message, Snackbar.LENGTH_LONG).show()
                        }
