...
import com.sngs.swayam.business.adapters.ProductListAdapter
                ...
                override fun onResponse(call: Call<GetCategoryListBaseResponse>, response: Response<GetCategoryListBaseResponse>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success_v?.toInt()==1)
                        {
                            ...
                            more_sub_catergory_rv.adapter = ProductListAdapter(Links.category_list, this@MoreSubCatogoryActivity)
                        }
                        else {
