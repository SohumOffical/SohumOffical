package com.sngs.swayam.business.adapters
...
import com.sngs.swayam.business.activity.MoreSubCatogoryActivity
...
class ServicesProviderListAdapter  (private var arrayList: List<ServiceListDatum>, private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(context).inflate(R.layout.service_provider_item_layout, parent, false)
        )
    }
